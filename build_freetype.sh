...
#  ===============================================================================================================
#  https://gist.github.com/ayansg/066f3ad7c84f9fd5f61651fc0d099bc3

BUILD_DIR=${PWD}/FreeType
mkdir -p ${BUILD_DIR}
cd $BUILD_DIR
...
./configure --without-zlib --without-png --without-bzip2 --host="aarch64-apple-darwin" --enable-static=yes --enable-shared=no
make clean
make
...
export AR="/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ar"
export LDFLAGS="-arch ${ARCH} -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk -miphoneos-version-min=$iphoneos"
./configure --without-zlib --without-png --without-bzip2 --host="${ARCH}-apple-darwin" --enable-static=yes --enable-shared=no
make clean
make
cp objs/.libs/libfreetype.a "${BUILD_DIR}/libfreetype-${ARCH}.a"
build_two="$ARCH"
...
./configure --without-zlib --without-png --without-bzip2 --disable-shared --enable-static --host="${ARCH}-apple-darwin"
make clean
make
cp objs/.libs/libfreetype.a "${BUILD_DIR}/libfreetype-${ARCH}.a"
build_four="$ARCH"
